...
function initializeWorld() {
    ...
    world.player = new Player(300, 550, 500, true, view("playerShip1_blue.png"));
...
function initializeEnemies(world) {
    ...
    for (var i = 0; i < world.nombre_enemies; i++) {
        ...
        if (0 <= i && i < 5) {
            world.enemies.add(new Enemie(k * 10, j * 10, world.vitesse_enemies, view("ufoGreen.png"), 1));
        } else if (5 <= i && i < 10) {

            world.enemies.add(new Enemie(k * 10, j * 10, -world.vitesse_enemies, view("ufoGreen.png"), 2));
        } else if (10 <= i && i < 15) {
